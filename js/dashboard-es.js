    ...
    $.ajax({
      ...
      complete: function(resp) {
        ...
        $.each(json.modulos, function(i, item) {
          ...
          info += '<div class="col-md-12"><small><a href="'+item.tipo_modulo.url_libreria+'" target="_blank" class="text-left text-primary">Descargar Lib.</a></small></div>';
          info += '<div class="col-md-12"><small><a href="#" class="eliminar_mod text-left" id="' + item.id + '">Eliminar</a></small></div></div>';
