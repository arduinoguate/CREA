  ...
  $('button[type="submit"]').click(function(e) {
    ...
    if (textfield.val() != "") {
      if (pass.val() != "") {
        ...
        $("#output").removeClass(' alert alert-success');
        $("#output").addClass("alert alert-danger animated fadeInUp").html("Write a password ");
      }
    } else {
      //remove success mesage replaced with error message
      $("#output").removeClass(' alert alert-success');
      $("#output").addClass("alert alert-danger animated fadeInUp").html("Write a username ");
    }
...
function logged(username) {
  ...
  $("#output").addClass("alert alert-success animated fadeInUp").html("Welcome " + "<span style='text-transform:uppercase'>" + username + "</span>");
